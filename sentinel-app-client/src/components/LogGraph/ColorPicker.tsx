...
const ColorPicker = ({
    ...
    const valuesForCriteria = availableValues[selectedCriteria] || [];
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="text-xs px-2 py-1 rounded bg-neutral-800 border border-neutral-700 text-neutral-200 hover:bg-neutral-700"
                >
                    {showValues ? "Hide colors" : "Show colors"}
                </button>
            </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style={{
                                        backgroundColor:
                                            existingColor?.color || predefinedColors[0],
                                    }}
                                >
                                    <input
                                        type="color"
